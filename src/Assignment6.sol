...
contract Assignment6 {
    ...
    function deposit() external payable {
        ...
        require(msg.value > 0 , 'User Has not enough balance');
    ...
    function withdraw(uint amount) external hasEnoughBalance(amount) payable {
